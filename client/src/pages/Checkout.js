...
const Checkout = () => {
  ...
  const checkoutHandler = async () => {
    ...
    const options = {
      ...
      prefill: {
        name: 'Dukaan-24/7',
        email: 'oda.moore45@ethereal.email',
        contact: '8957400842',
      },
      notes: {
        address: 'Dukaan-24/7 Office',
      },
      theme: {
        color: '#61dafb',
      },
        ...
        <div className="row">
          <div className="col-lg-7 mb-4">
            <div className="checkout-left-data">
              <h3 className="website-name">Dukaan-24/7</h3>
              <nav
              ...
              <p className="user-details total">Dukaan-24/7@gmail.com</p>
