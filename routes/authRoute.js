...
router.post('/order/cash-order',authMiddleware.authMiddleware, userController.createOrder);
router.get('/order/get-orders',authMiddleware.authMiddleware, userController.getAllOrders);
