...
router.get('/get-orders',authMiddleware.authMiddleware, userController.getOrders);
router.get('/get-all-orders',authMiddleware.authMiddleware, authMiddleware.isAdmin, userController.getAllOrders);
router.put('/order/update-order/:id',authMiddleware.authMiddleware, authMiddleware.isAdmin,userController.updateOrderStatus);
